...
insert into car values(seq_car_no.nextval,'카니발','대형차',36000,5,'경유','제성1길 62,3층','img/car/carnival.png');
insert into car values(seq_car_no.nextval,'스타렉스','대형차',35000,5,'휘발유','제성1길 62,3층','img/car/starex.png');